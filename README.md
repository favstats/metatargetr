...
- 🎯 [Get Targeting Criteria](#get-targeting-criteria-last-30-days)
...
- 🖼️ [Get Ad Snapshots (Images, Videos, and
...
- 📄 [Fetch and Cache Ad HTML](#fetch-and-cache-ad-html)
- 🔗 [Get Deeplink Data](#get-deeplink-data)
...
`get_ad_snapshots()` retrieves snapshot data for a Facebook ad from the
...
browser session. This passes Facebook’s JS challenge once during
...
`get_ad_html()` fetches the raw HTML for one or more ads and caches
